...
3. **Borrar ≠ liquidar**: Son dos acciones con lógica distinta. Liquidar una deuda no necesita consenso. Ver `docs/ARCHITECTURE.md#debt-settlement`.
...
8. **Delta sync por grupo**: Al sincronizar, intercambiar solo registros con `updatedAt > lastSyncTimestamp` filtrado por `groupId`.
